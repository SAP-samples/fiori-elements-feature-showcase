sap.ui.define(["sap/ui/core/library"], function (coreLibrary) {
  ...
  return {
    ...
    itemPressColumn: function (oEvent) {
      ...
      const closeSideContent = () => {
        this.showSideContent("childEntities1Section", false);
      };
  ...
  function itemPress(oEvent) {
    ...
    switch (oItem.getState()) {
      case "Error":
        colorState = coreLibrary.IconColor.Negative;
        break;
      case "Warning":
        colorState = coreLibrary.IconColor.Critical;
        break;
      case "Success":
        colorState = coreLibrary.IconColor.Positive;
        break;
    }
