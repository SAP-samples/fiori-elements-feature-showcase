...
annotate srv.RootEntities with @(
    UI.LineItem : [
        ...
        },
        {
            ...
            $Type               : 'UI.DataFieldForAction',
            Action              : 'LROPODataService.changeCriticality', //Reference to the action of the CAP service
            Label               : '{i18n>changeCriticality}',
        },
        {
        ...
        {
            $Type               : 'UI.DataFieldForAction',
            Action              : 'LROPODataService.EntityContainer/criticalAction', //Unbound actions need to be referenced through the entity container (Action import)
            Label               : '{i18n>criticalAction}',
        },
        {
            $Type : 'UI.DataFieldForAction',
            Action : 'srv.resetEntities(srv.RootEntities)', //Static action
