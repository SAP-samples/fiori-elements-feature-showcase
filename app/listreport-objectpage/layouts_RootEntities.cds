    ...
    UI.Identification : [
        {
            ...
            //Action in the RootEntities of the object page next to the edit button
...
annotate srv.RootEntities with @(
    UI.LineItem                : [
        ...
        },
        {
            ...
            $Type         : 'UI.DataFieldForAnnotation',
            //Added progress indicator to table
        ...
        },
        {
            ...
            $Type         : 'UI.DataFieldForAnnotation',
            //Added rating indicator to table
        ...
        },
        {
            ...
            $Type : 'UI.DataFieldForAction',
            Action: 'LROPODataService.changeCriticality',
            //Reference to the action of the CAP service
            Label : '{i18n>changeCriticality}',
        },
        {
        ...
        },
        {
            ...
            //Unbound actions need to be referenced through the entity container (Action import)
            Label : '{i18n>unboundAction}',
        },
        {
            $Type : 'UI.DataFieldForAction',
            Action: 'LROPODataService.EntityContainer/criticalAction',
            //Unbound actions need to be referenced through the entity container (Action import)
            Label : '{i18n>criticalAction}',
        },
        {
            $Type : 'UI.DataFieldForAction',
            Action: 'srv.resetEntities(srv.RootEntities)',
            //Static action
...
annotate srv.RootEntities with @(
    ...
    UI.FieldGroup #Section          : {Data: [
        ...
        {Value: description_customGrowing},
        {
            ...
            //Specifies the app of the target entity
            RequiresContext: true,
            //If a row has to be selected or not
            IconUrl        : 'sap-icon://cart',
            //Icons only supported for inline actions / intend based navigation
            //Criticality is ignored, when using icons
            Mapping        : [{
    ...
    // Search-Term: #Form
    UI.FieldGroup #ShowWhenInEdit   : {Data: [
        {Value: stringProperty},
        {Value: fieldWithCriticality},
        {Value: fieldWithUoM},
        {Value: fieldWithPrice},
    ...
    UI.FieldGroup #chartData        : {Data: [
        {Value: integerValue},
        {Value: targetValue},
        {Value: forecastValue},
        {Value: dimensions},
    ]},
    UI.FieldGroup #advancedChartData: {Data: [
    ...
    UI.FieldGroup #communication    : {Data: [
        {Value: email},
        {Value: telephone}
    ]},
    // Displaying Date, Time or TimeStamp values is done by SAP Fiori elements out of the Box
    UI.FieldGroup #timeAndDate      : {Data: [
        {Value: validTo},
        {Value: time},
        {Value: timeStamp}
    ]},
    // Search-Term: #PlainText
    UI.FieldGroup #plainText        : {Data: [{Value: description}]},
);
...
annotate srv.RootEntities with @(UI.HeaderInfo: {
...
annotate srv.RootEntities with @(UI.HeaderFacets: [
    {
...
annotate srv.RootEntities with @(UI.Facets: [
    {
        $Type : 'UI.CollectionFacet',
    ...
    },
    {
        ...
        //Used for Header Facet Navigation
        Facets: [
            {
                $Type : 'UI.ReferenceFacet',
            ...
            },
            {
                ...
                //Search-Term: #InboundNav //Used for RootEntities facet navigation
...
annotate srv.RootEntities with @(UI.SelectionPresentationVariant #SelectionPresentationVariant: {
...
annotate srv.RootEntities with @(
    ...
    //Can also be a dynamic property path
    },
);
