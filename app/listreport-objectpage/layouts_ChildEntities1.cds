...
using from './layouts_GrandChildEntities';

// UI.LineItem
annotate srv.ChildEntities1 with @(UI.LineItem: [
    {
        $Type: 'UI.DataField',
        Value: field,
    },
...
// UI.HeaderFacets
annotate srv.ChildEntities1 with @(UI.HeaderFacets: [{
...
// UI.Facets
annotate srv.ChildEntities1 with @(UI.Facets: [{
    $Type : 'UI.ReferenceFacet',
...
// UI.DataPoint
annotate srv.ChildEntities1 with @(UI.DataPoint #fieldWithPercent: {
    Value        : fieldWithPerCent,
...
annotate srv.ChildEntities1 with @(UI.PresentationVariant: {
    SortOrder     : [{
        Property  : field,
        Descending: false,
    }, ],
...
/**
    UI.SelectionVariant
 */
annotate srv.ChildEntities1 with @(
